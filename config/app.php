...
//        Barryvdh\LaravelIdeHelper\IdeHelperServiceProvider::class,//代码提示工具 Laravel IDE Helper
//        Jenssegers\Mongodb\MongodbServiceProvider::class,//Mongodb
//        Maatwebsite\Excel\ExcelServiceProvider::class,//providers元素添加
    ],
